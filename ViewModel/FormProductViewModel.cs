...
namespace UploadFiles.ViewModel
{
    public class FormProductViewModel
    {
        ...
        public int CategoryId { get; set; } // for edit and create
        [DisplayName("Categories")]

        public IEnumerable<SelectListItem> SelectCategoriesList { get; set; } = Enumerable.Empty<SelectListItem>(); // for edit
